...
## 📌 v0.3.93 / extension v0.3.52 重要更新（2026-05-29）

- **♥ 独立收藏夹** —— 全新「收藏」功能，与「稍后再看」互相独立：推荐卡 / 惊喜卡点 ♡ 即收藏，永久留存长期回顾。
- **📚 三端收藏 / 稍后浏览页** —— 移动端、插件、桌面端均新增收藏与稍后再看的浏览入口，终于有地方集中查看收藏过的内容了。
- **🗂️ 数量徽章与单条移除** —— 桌面端侧边栏收藏 / 稍后入口带数量徽章，列表内可点击打开或单条移除。
